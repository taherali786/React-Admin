             ...
             <div className="content-header">
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <h1 className="m-0">{ isloading?<Skeleton shape="rectangle" width="30%" height="2rem" ></Skeleton> :'Dashboard'}</h1>
                    </div>{/* /.col */}
                    <div className="col-sm-6">
                    { isloading?<Skeleton shape="rectangle" width="50%" height="2rem" className="breadcrumb float-sm-right"></Skeleton>
                    ...
                    <div className="row">
                            ...
                            <>
                                {/* <div className="p-grid p-mb-2"> */}
                                        ...
                                        <div className="col-3 mb-3">
                                            <Skeleton shape="rectangle" width="99%" height="9rem" className="ml-1"></Skeleton>
                                        </div>
                                        <div className="col-3 mb-3">
                                            <Skeleton shape="rectangle" width="99%" height="9rem" className="ml-1" ></Skeleton>
                                        </div>
                        ...
                        :(  
                            ...
                            <div className="col-lg-3 col-6">
                                ...
                                <a href="index4.html" className="small-box-footer">More info <i className="fas fa-arrow-circle-right" /></a>
                                </div>
                            </div>
                            {/* ./col */}
                            <div className="col-lg-3 col-6">
                    ...
                    <section className="col-lg-7 connectedSortable">
                        ...
                        <div className="card-header">
                            ...
                            <ul className="pagination pagination-sm">
                                <li className="page-item"><a href="index4.html" className="page-link">«</a></li>
                                <li className="page-item"><a href="index4.html" className="page-link">1</a></li>
                                <li className="page-item"><a href="index4.html" className="page-link">2</a></li>
                                <li className="page-item"><a href="index4.html" className="page-link">3</a></li>
                                <li className="page-item"><a href="index4.html" className="page-link">»</a></li>
                            </ul>
                            </div>
                        </div>
                    ...
                    <section className="col-lg-5 connectedSortable">
                        ...
                        <div className="card-header border-0">
                            ...
                            <div className="btn-group">
                                ...
                                <a href="index4.html" className="dropdown-item">Add new event</a>
                                <a href="index4.html" className="dropdown-item">Clear events</a>
                                <div className="dropdown-divider" />
                                <a href="index4.html" className="dropdown-item">View calendar</a>
                                </div>
                            </div>
